...
public class ProfileGUI extends Application {
    ...
    public void start(Stage PrimaryStage) throws Exception {
        ...
        //Image settings
        Image profilePic = new Image("../client/ProfilePicTestImage.jpg");
        ...
        profileInfoGridPane.addColumn(2, test, test, test, test, test, test, test, test, test, test);
        ...
        profileInfoPane.getChildren().addAll(profileInfoTitlePane,profileInfoGridPane);
        ...
        profileInfoContinuedGridPane.addColumn(2,test,test,test);
        ...
        profileInfoCoursesGridPane.addColumn(2,test,test,test);
